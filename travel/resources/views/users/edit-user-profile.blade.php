    ...
    <div class="container">
        <div class="row">
            <div class="col-xs-12">
                ...
                <div class="form-group">
                    <div>
                        {!! Form::label('blog_link', 'Personal Blog Link:', ['class'=>'col-sm-2 control-label']) !!}
                        <div class="col-sm-10">
                ...
                <div class="form-group">
                    <div>
                        {!! Form::label('about_yourself', 'Somthing About You:', ['class'=>'col-sm-2 control-label']) !!}
                        <div class="col-sm-10">
                ...
                <div class="form-group">
                    <div>
                        {!! Form::label('travel_style', 'Travel Style:', ['class'=>'col-sm-2 control-label']) !!}
                        <div class="col-sm-10">
